...
$lignes = file("data/Fiches.txt", FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
$fichesListe = [];
...
// Lecture des loisirs
$lignesLoisirs = file("data/Loisirs.txt", FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
$loisirsStructure = [];
